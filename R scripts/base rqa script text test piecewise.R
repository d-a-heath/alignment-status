...
setwd("C:/Users/daheath/OneDrive - The University of Memphis/Alignment Status/CANDOR/test set")

dataset = read.csv("C:/Users/daheath/OneDrive - The University of Memphis/Alignment Status/CANDOR/test set/test transcripts/spacy test/00ae2f18-9599-4df6-8e3a-6936c86b97f0_transcript_cliffhanger_output_cleaned.csv")
...
rec_categorical_radius = .01

######## 3b. Run recurrence quantification analysis ########

# run rqa over informative text
recurrence_analysis_transcript = piecewiseRQA(ts1=data,
                                       ts2=data,
                                       blockSize = 100,
                                       delay=1,
                                       embed=1,
...
recurrence_analysis_plot_transcript = piecewiseRQA(ts1=data,
                                            ts2=data,
                                            blockSize = 100,
                                            delay=1,
                                            embed=1,
...
plot_rp(recurrence_analysis_plot_transcript$RP, title = "plot", xlabel = "text", ylabel = "text", pcolour = "blue" )
#ggplot(recurrence_analysis_plot_transcript$RP)
